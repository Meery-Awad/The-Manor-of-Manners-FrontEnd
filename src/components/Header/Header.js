...
const Header = () => {
  ...
  return (
    <header className={`Header bg-white fixed top-0 left-0 w-full z-50 shadow-md text-xl`}>
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          {/* Logo */}
          <div className="flex-1 md:flex md:items-center md:gap-12">
            <a className="block text-teal-800" href="#">
          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            >
              <ul className="flex flex-col md:flex-row items-center gap-4 pb-2 ">
                {navItems.map((item) => (
                  <li key={item.id}>
                    <NavLink
                ...
                {id === '' ? (
                  <>
                    <NavLink
                      className="rounded-md bg-[#2a143d] px-3 py-2 font-medium text-white shadow-sm"
                      to="Login"
                      onClick={() => setMenuOpen(false)}
                    >
                      Login
                    ...
                    <NavLink
                      className="rounded-md bg-gray-100 px-3 py-2 font-medium text-[#2a143d]"
                      to="Register"
                      onClick={() => setMenuOpen(false)}
                    >
                      Register
